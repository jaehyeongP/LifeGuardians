...
<%--<div id="rate_add_section" class="rate_add_section" style="border-width:2px !important; border-style:solid !important; border-color:black !important; border-radius:10px !important; overflow:scroll; height: 75%; ">--%>
...
<div class="d-flex">
    <div class="m-2 p-2" id="user_name_review" style="font-weight:bold"> 회원님  </div>
    ...
    <form id="review_submit_form">
        ...
        <div id="add_good" class="add_good d-flex m-4 " style="height: 15%;">
            ...
            <label for="good" >
                <img id='goodImage'  onclick='changeImageGood()'  src="https://creazilla-store.fra1.digitaloceanspaces.com/emojis/47713/smiling-face-emoji-clipart-md.png"
                     class = "smile"
                     alt width = "44"
                     height = "44">
        ...
        <div id="add_bad" class="add_bad d-flex m-4 " style="height: 15%;">
            ...
            <label for="bad" >
                <img id='badImage'  onclick='changeImageBad()'  src="https://w7.pngwing.com/pngs/699/293/png-transparent-emoji-emoticon-expression-annoyed-emoji-icon-thumbnail.png"
                     class = "smile"
                     alt width = "44"
                     height = "44">
        ...
        <div id="add_worst" class="add_worst d-flex m-4 " style="height: 15%;">
            ...
            <label for="worst" >
                <img id='worstImage'  onclick='changeImageWorst()'  src="https://creazilla-store.fra1.digitaloceanspaces.com/emojis/55893/angry-face-emoji-clipart-md.png"
                     class = "smile"
                     alt width = "44"
                     height = "44">
            ...
            <div id="submit_div" class="ab w-50 h-50 m-2 p-2" >
                <button type ="submit" style="border: none; padding: 0; background: none;" >
                    <img src="/resource/assets/img/emoji/image_processing20200510-10310-2x47zj(3).svg"  class = "smile img-fluid mb-5 pb-5">
                </button>
